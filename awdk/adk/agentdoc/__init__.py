...
Quick start:
    ...
    from adk.agentdoc import spec, hidden, doc, pformat, truncating_pformat
...
# Version stub: port from NVIDIA NOOA (Apache-2.0)
__version__ = "1.0.0"

from adk.agentdoc._docs import spec
from adk.agentdoc._pformat import _pformat
from adk.agentdoc._truncating_stream import (
    FileBackedTruncatingStringIO,
    TruncatingStringIO,
)
from adk.agentdoc._visibility import hidden
from adk.agentdoc.core import doc
from adk.agentdoc.doc_config import DocConfig

__submodules__ = ["ext", "introspect", "visibility"]
