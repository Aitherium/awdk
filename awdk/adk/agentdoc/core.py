...
from adk.agentdoc._pformat import _pformat_to_str as _pformat
from adk.agentdoc._structured import format_type as _format_type_impl
from adk.agentdoc.doc_config import DocConfig
from adk.agentdoc.format import (
