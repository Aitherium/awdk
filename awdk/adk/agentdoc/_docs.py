...
from adk.agentdoc._metadata import set_docs_metadata, set_field_metadata
    ...
    **Default visibility rules:**
    ...
    def define_doc(self, target) -> Any:
        ...
        **For a module** — extractor receives the module, returns ``ModuleInfo``::
            ...
            import numpy
            from adk.agentdoc.ext import ModuleInfo, CallableInfo
        ...
        if inspect.ismodule(target):
            from adk.agentdoc.registry import register_module_info_extractor

            return register_module_info_extractor(target)

        from adk.agentdoc.registry import register_type_info_extractor
