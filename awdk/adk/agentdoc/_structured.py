...
from adk.agentdoc._info import REQUIRED, CallableInfo, FieldInfo, ModuleInfo, TypeInfo
from adk.agentdoc.protocols import SupportsCallableInfo, SupportsTypeInfo
...
def _extract_dataclass_fields(obj: type) -> list[FieldInfo]:
    ...
    from adk.agentdoc._metadata import get_field_metadata
    from adk.agentdoc._visibility import is_hidden_field
...
def _extract_methods(obj: type) -> list[CallableInfo]:
    ...
    """
    from adk.agentdoc._visibility import is_hidden_method
    ...
    from adk.agentdoc._metadata import _FIELDS_ATTR  # noqa: PLC0415
