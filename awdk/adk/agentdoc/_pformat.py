...
from adk.agentdoc._info import REQUIRED, CallableInfo, ModuleInfo, TypeInfo
from adk.agentdoc._metadata import is_expand_false
from adk.agentdoc._structured import _ClassRef, _InstanceRef
from adk.agentdoc.protocols import SupportsInstanceValues
...
def _collect_referenced_types_transitive(
    ...
    """
    from adk.agentdoc._discover import discover_referenced_types
    ...
    *,
    ...
    match _object:
        ...
        case type():
            ...
            from adk.agentdoc._structured import extract_type_info
        ...
        case _ if inspect.ismodule(_object):
            from adk.agentdoc.registry import get_module_info_extractor

            extractor = get_module_info_extractor(_object)
            if extractor is not None:
                module_info = extractor(_object)
            else:
                from adk.agentdoc._structured import extract_module_info
        ...
        case _ if inspect.isfunction(_object) or inspect.ismethod(_object):
            from adk.agentdoc._structured import extract_callable_info
        ...
        case _ if _is_structured_instance(_object):
            ...
            if instance_mode == "type":
                ...
                from adk.agentdoc._structured import extract_type_info
                from adk.agentdoc._visibility import is_hidden_field
                from adk.agentdoc.protocols import SupportsInstanceValues
                from adk.agentdoc.registry import get_type_info_extractor
...
def _format_type_info(
    ...
    *,
    ...
    if instance_values:
        extra_attrs = []
        from adk.agentdoc._visibility import is_hidden_field as _is_hidden_field
    ...
    if context_obj is not None and type_depth > 0:
        from adk.agentdoc._discover import (
...
def _field_spec_override(obj_type: type, field_name: str, key: str) -> Any:
    ...
    from adk.agentdoc._docs import SpecAnnotation
...
def _format_instance_repr(
    ...
    *,
    ...
    if extractor:
        ...
        from adk.agentdoc._visibility import is_hidden_field  # noqa: PLC0415
